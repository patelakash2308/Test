...
<a href="#AddEngineerModel" role="button" class="btn btn-primary" data-toggle="modal"><i class="fa fa-plus"></i> &nbsp; New Engineer</a>
		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button class="btn btn-primary" data-dismiss="modal">Add Engineer</button>
				</div>
			  </div>
			</div>
		</div>
		...
		<div class="modal small fade" id="EngDeleteModal" tabindex="-1" role="dialog" aria-labelledby="EngDeleteModal" aria-hidden="true">
		  <div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p class="error-text"><i class="fa fa-warning modal-icon"></i>Are you sure you want to delete the engineer?<br>This cannot be undone.</p>
				</div>
				<div class="modal-footer">
					<button class="btn btn-default" data-dismiss="modal" aria-hidden="true">Cancel</button>
