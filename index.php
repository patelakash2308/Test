  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          <a class="" href="#"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> Complain Management System</span></a></div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form>
                ...
                <a href="dashboard.php" class="btn btn-primary pull-right">Sign In</a>
                <label class="remember-me"><input type="checkbox"> Remember me</label>
                <div class="clearfix"></div>
            </form>
        </div>
    </div>
    <p class="pull-right" ><a href="sign-up.php">Sign Up</a></p>
